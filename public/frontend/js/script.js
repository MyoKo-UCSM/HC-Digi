...
(function ($) {
	...
	================================================== */
	(function ($) {
		var container = $('#container'), responsive_nav_wrap, responsive_nav, header = $('#header');
		var menu = header.find('#nav:eq(0)');
		var show_menu = $('<a id="responsive_nav_open" href="#" class=""><i class="fa fa-list-ul"></i></a>'),
		...
		$.fn.wt_responsive_nav = function () {
			...
			if (header.is('.drop_down_nav')) {
				...
				var menu_item = responsive_nav.find('a'),
	...
	$(window).resize(() => $.fn.wt_responsive_nav());

	// Short Content Set Height
	if (document.querySelector(".short-content")) {
		function setMainMinHeight() {
			const headerSize = document.querySelector("#header_wrapper").getBoundingClientRect().height;
			const footerSize = document.querySelector("#footer").getBoundingClientRect().height;
