    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ url('/admin') }}" class="d-lg-none">
                <img alt="Logo" src="{{ asset('backend/images/GRG-Logo.png') }}" class="h-30px" />
            </a>
        </div>
        <div class="d-flex align-items-stretch flex-shrink-0">
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true" style="">
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{ asset('backend/images/admin.jpg') }}">
                                </div>
                                <div class="d-flex flex-column">
                                    <div class="fw-bolder d-flex align-items-center fs-5">

                                        <span class="badge badge-light-primary fw-bolder fs-8 px-2 py-1 ms-2">{{ auth()->user()->name }}</span>
                                    </div>
                                    <span href="#" class="fw-bold text-muted text-hover-primary fs-7">{{ auth()->user()->email }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="separator my-2"></div>
                        {{-- <div class="menu-item px-5">
                            <a href="#" class="menu-link px-5 position-relative">Look For Support?
                        ...
                        <div class="menu-item px-5 pt-4">
                            <a href="#" class="menu-link px-5 position-relative">Contact Web Developer
                                <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                        ...
                        <div class="menu-item px-5 pt-4">
                            <a href="{{ url('logout') }}" class="menu-link px-5 position-relative" onclick="event.preventDefault();
