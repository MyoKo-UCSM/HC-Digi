...
@section('breadcrumb-info', 'Position Lists')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="row mb-2">
                    ...
                    <div class="col-md-3 text-end">
                        <a href="{{ url('/admin/position/create') }}" class="btn btn-primary btn-sm pull-right" title="Add New Position">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table align-middle table-row-bordered dataTable no-footer requestDelete" id="positionTable">
...
@push('scripts')
    <script>
        $(document).ready(function(){
            ...
            $("table.positionTable_filter").append($("#statusFilter"));
