...
@section('breadcrumb-info', 'SubDepartment Lists')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="row mb-2">
                    ...
                    <div class="col-md-3 text-end">
                        <a href="{{ url('/admin/sub-department/create') }}" class="btn btn-primary btn-sm pull-right" title="Add New SubDepartment">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table align-middle table-row-bordered dataTable no-footer requestDelete" id="subDepartmentTable">
...
@push('scripts')
    <script>
        $(document).ready(function(){
	        ...
	        me.table = $("#subDepartmentTable").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/admin/sub-department/getData",
                    type: 'POST',
                    headers: {
            ...
            $("table.subDepartmentTable_filter").append($("#statusFilter"));
